Step by step exercise 1 topic 4 (Spring):
...
4)Also I built a JAR file with mvnw clean package and I upload the file so you can ran with this command: java -jar gs-rest-service-0.1.0.jar
